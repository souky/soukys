...
//import com.jy.common.kafka.constant.KafkaMesConstant;
//
///**
// * kafkaProducer模板
// * 	使用此模板发送消息
...
//	 * @param app 应用（anti_cheat balanced_edu...）
//	 */
//	public Map<String,Object> sndMesForTemplate(String topic, Object value, String ifPartition, 
//			Integer partitionNum, String app){
//		String key = app;
//		String valueString = value.getClass().equals(String.class)? value.toString():JSON.toJSONString(value);
